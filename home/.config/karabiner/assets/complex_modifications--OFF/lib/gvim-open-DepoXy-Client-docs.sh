...
#
#   "shell_command": "/usr/local/bin/bash -c '/usr/local/Cellar/macvim/latest/MacVim.app/Contents/bin/gvim --servername ${GVIM_OPEN_SERVERNAME:-SAMPI} --remote-send \"<ESC>:silent! call g:embrace#windows#FocusCursorInNextNormalBufferWindow()<CR>\" --remote-silent ${DEPOXYDIR_STINTS_FULL:-${HOME}/.depoxy/stints}/XXXX/docs/Backlog_Client_XXXX.rst'"
